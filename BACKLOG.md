...
- [ ] Migrera alla `Alert.alert` (62 anrop i 10 filer) till nya `ConfirmDialog`/`useConfirm` så bekräftelse- och valdialoger får rundade hörn och appens stil i stället för native OS-alerts som sticker ut. Komponent + provider finns; performer-pickern i sysslor är migrerad som start.
