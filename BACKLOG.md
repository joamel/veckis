...
- [x] Välja vecka när man trycker kalender-ikonen i receptlistan: dag-picker-sheetet i `recipes/index.tsx` har nu veckochips (aktuell + 4 framåt) ovanför dagvalet. "Planerad"-indikatorn visas bara för nuvarande vecka (vi laddar bara in den veckans meny).
