...
- [ ] Onboarding-tip för förlåtande-modellen: first-time-tooltip eller info-ikon vid status-texten som förklarar att missade tillfällen *inte nag:ar utan blir tyst historik*, och att grace-fönstret räcker till nästa tillfälle. Annars finns risk att användaren missförstår beteendet ("varför naggar den inte!?").
