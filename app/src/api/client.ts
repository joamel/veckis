...
export function useApiClient() {
  ...
  return useMemo(() => ({
    ...
    createStore: (data: { householdId: string; name: string; categoryOrder?: StoreCategory[]; customCategories?: string[]; expandedSubs?: string[]; subOrder?: string[]; customSubs?: Record<string, string[]>; parentOrder?: string[] }) =>
      request<Store>('/api/stores', { method: 'POST', body: JSON.stringify(data) }),

    updateStore: (storeId: string, data: { name?: string; categoryOrder?: StoreCategory[]; customCategories?: string[]; expandedSubs?: string[]; subOrder?: string[]; customSubs?: Record<string, string[]>; parentOrder?: string[] }) =>
