        ...
        <View style={s.metaRow}>
          ...
          {recipe.sourceUrl && (
            ...
            >
              ...
              <Text style={[s.metaText, { color: '#4f46e5', flexShrink: 0, includeFontPadding: false, paddingRight: 2, letterSpacing: 0.2 }]}>Originalrecept</Text>
            </Pressable>
          )}
        </View>
...
const s = StyleSheet.create({
  ...
  metaChip: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#f3f4f6', paddingLeft: 10, paddingRight: 14, paddingVertical: 6, borderRadius: 20, flexShrink: 0 },
