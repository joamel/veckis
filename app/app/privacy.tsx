...
export default function PrivacyScreen() {
  ...
  return (
    <LegalPage title="Integritetspolicy">
      ...
      <Text style={s.p}>
        Backend körs på Railway och dina uppgifter lagras i en
        PostgreSQL-databas hos Neon. Inloggning hanteras av Clerk och
        receptbilder lagras på Cloudinary. Vi delar inga uppgifter med
