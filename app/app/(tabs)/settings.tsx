    ...
    <SafeAreaView style={styles.container} edges={nyDesign ? ['top', 'left', 'right'] : undefined}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          >
            {/* Aktivt hushåll: mörkgrön bricka med limeikon, samma som den
                aktiva raden i hushållsväxlaren. */}
            <View style={styles.householdIcon}>
              {/* Fylld ikon på det aktiva hushållet, samma som i växlaren. */}
              <Ionicons name={nyDesign ? 'home' : 'home-outline'} size={20} color={nyDesign ? ny.lime : c.primary} />
            </View>
            ...
            <View style={styles.inlineExpand}>
              {allMemberships.map((membership, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Ny design: aktivt hushåll mörkgrönt med limeikon, övriga
          ...
          <View style={styles.membersBox}>
            ...
            {householdMembers.map((member, idx) => (
              ...
              >
                ...
                {nyDesign && (
                  <View style={[styles.nyRund, idx % 2 === 0 ? styles.nyRundMork : styles.nyRundLjus]}>
                    <Text style={[styles.nyMedlemText, idx % 2 === 0 ? styles.nyMedlemTextMork : styles.nyMedlemTextLjus]}>
                ...
                <View style={styles.memberInfo}>
                  ...
                  {nyDesign && member.role === 'admin' && (
                    <View style={styles.nyAdminMarke}>
                      <Ionicons name="shield-checkmark" size={11} color={ny.skog} />
                      <Text style={styles.nyAdminMarkeText}>{str.member.admin}</Text>
                    </View>
                  )}
                </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.linkBox}>
            <Pressable style={styles.linkRow} onPress={() => setShowCreateHouseholdModal(true)}>
              ...
              <Ionicons name="chevron-forward" size={16} color={nyDesign ? ny.kontur : c.border} />
            </Pressable>
...
const makeStyles = (c: Palette, nyD: boolean, ny: NyPalett) => StyleSheet.create({
  ...
  householdIcon: {
    ...
    height: 44,
    borderRadius: 22,
    backgroundColor: nyD ? ny.skog : c.primaryTint,
    alignItems: 'center',
    justifyContent: 'center',
  },
  userInfo: { flex: 1 },
  ...
  memberInfo: { flex: 1 },
  memberName: nyD
    ? { fontFamily: nyFont.fet, fontSize: 16, letterSpacing: -0.2, color: ny.text }
