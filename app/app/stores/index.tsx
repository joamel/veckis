...
export default function StoresScreen() {
  ...
  // "Ingen butik"-rad + "skapa ny" visas extra. Om användaren backar utan val
  // resolveras väljaren med null via useEffect-cleanup.
    ...
    <SafeAreaView style={s.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingTop: 12, paddingBottom: 120 }}>
        {pickMode && (
          <Pressable
            style={s.card}
            onPress={() => { resolveStorePick(null); router.back(); }}
          >
            <View style={[s.cardIcon, { backgroundColor: '#f3f4f6' }]}>
              <Ionicons name="close-outline" size={20} color="#6b7280" />
            </View>
            <View style={{ flex: 1 }}>
              <Text style={s.cardTitle}>Ingen butik</Text>
              <Text style={s.cardMeta}>Listan har ingen butikskoppling</Text>
            </View>
          </Pressable>
        )}
            ...
            return (
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  {catCount > 0 && <Text style={s.cardMeta}>{catCount} kategorier</Text>}
                </View>
                {!pickMode && <Ionicons name="chevron-forward" size={18} color="#d1d5db" />}
              </Pressable>
            );
          })
        )}
